...
export function gapBg(pct: number | null): string {
  ...
  if (pct <= 10) return "#10b98115";
  if (pct <= 25) return "#f59e0b15";
  return "#ef444415";
}
          ...
          <>
            ...
            <div style={{
              ...
              <div style={{ textAlign: "center", flex: 1 }}>
                <div style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", color: "#f59e0b" }}>
                  {detail.event.source === "goldbet" ? "Goldbet" : detail.event.source === "kambi" ? "Kambi" : "Source"}
                </div>
